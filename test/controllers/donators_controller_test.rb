...
class DonatorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create donator" do
    assert_difference('Donator.count') do
      post donators_url, params: { donator: { box_id: @donator.box_id, name: @donator.name } }
    end
  ...
  test "should update donator" do
    patch donator_url(@donator), params: { donator: { box_id: @donator.box_id, name: @donator.name } }
